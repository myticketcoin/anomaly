...
This will build anomaly-qt as well if the dependencies are met.
...
If you want to build anomaly-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a anomaly-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip anomalyd" to strip the debug
