    ...
    platformStyle(_platformStyle)
{
    ...
    anomalyVersionChecker = new AnomalyVersionChecker(this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Anomaly address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Anomaly addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Anomaly addresses"));
    ...
    openAction->setStatusTip(tr("Open a anomaly: URI or payment request"));//Anomaly_LINE

    showHelpMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Anomaly command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        {
            QString link = QString("<a href=%1>%2</a>").arg(Anomaly_RELEASES, Anomaly_RELEASES);
            QString message(tr("New version of Anomaly wallet is available on the Anomaly source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Anomaly network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Anomaly"); // default title
