    ...
    platformStyle(_platformStyle)
{
    ...
    anomalyVersionChecker = new AnomlayVersionChecker(this);
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Anomlay address"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Anomlay addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Anomlay addresses"));
    ...
    openAction->setStatusTip(tr("Open a anomaly: URI or payment request"));//Anomlay_LINE

    showHelpMessageAction = new QAction(platformStyle->MenuColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Anomlay command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::setClientModel(ClientModel *_clientModel)
{
    ...
    if(_clientModel)
    {
        ...
        {
            QString link = QString("<a href=%1>%2</a>").arg(Anomlay_RELEASES, Anomlay_RELEASES);
            QString message(tr("New version of Anomlay wallet is available on the Anomlay source code repository: <br /> %1. <br />It is recommended to download it and update this application").arg(link));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Anomlay network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Anomlay"); // default title
