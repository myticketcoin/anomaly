...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " anomaly-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  anomaly-tx [options] <hex-tx> [commands]  Update hex-encoded anomaly transaction\n" +
            "or:     anomaly-tx [options] -create [commands]   Create hex-encoded anomaly transaction\n" +
            "\n";
